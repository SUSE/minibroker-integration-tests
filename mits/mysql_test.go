...
var _ = Describe("MySQL", func() {
	...
	It("should deploy and connect", func() {
		...
		appName := generator.PrefixedRandomName(mitsConfig.Tests.MySQL.Class, "app")
		serviceName := generator.PrefixedRandomName(mitsConfig.Tests.MySQL.Class, "service")
		securityGroupName := generator.PrefixedRandomName(mitsConfig.Tests.MySQL.Class, "security-group")
		...
		err := service.Create(mitsConfig.Tests.MySQL, params, mitsConfig.Timeouts.CFCreateService)
